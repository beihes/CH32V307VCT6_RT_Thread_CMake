...
rt_inline rt_int32_t sdio_match_card(struct rt_mmcsd_card *card, const struct rt_sdio_device_id *id);
...
static rt_int32_t cistpl_funce_func0(struct rt_mmcsd_card *card, const rt_uint8_t *buf, rt_uint32_t size)
{
...
static rt_int32_t cistpl_funce_func(struct rt_sdio_function *func, const rt_uint8_t *buf, rt_uint32_t size)
{
    rt_uint32_t version;
